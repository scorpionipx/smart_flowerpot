...
#define HUMIDITY_SENSOR_1_ID 0x02     // ID FOR UART HUMIDITY 1 LEVEL DATA
#define HUMIDITY_SENSOR_2_ID 0x03     // ID FOR UART HUMIDITY 2 LEVEL DATA
#define TEMPERATURE_ID 0x04     // ID FOR UART TEMPERATURE DATA
